...
func isForceWith (force : String) -> Bool {
    if (force == "Luke" || force == "Leia" || force == "Anakin" || force == "Obi Wan" || force == "Yoda" || force == "Vader"){
        return true
    }
...
*/
// write your code here
func transferBalance (bank1 : Float, bank2 : Float){
